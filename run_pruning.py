...
original_model_dir = './saved_models/vgg19/实验十六3/'#args.modeldir[0] 
original_model_name = '20push0.7622.pth'#args.model[0] 
...
tnt.test(model=ppnet_multi, dataloader=test_loader, dataloader1=inst_loader,
